<?php
/**
 * Šablono dalis, skirta rodyti įrašo metaduomenis.
 *
...
// Rodyti datą tik tada, kai įrašo tipas yra „post“ arba yra archyvas.
...
// Rodyti autorių, tik jei įrašo tipas jį palaiko.
...
// Rodyti tėvinį įrašą, tik jei galimas ir jei įrašo tipas yra „attachment“.
...
<div class="entry__meta">
	...
	if ( ! empty( $time_string ) ) {
		...
		<span class="posted-on">
			...
			printf(
				...
				esc_html_x( 'Posted on %s', 'post date', 'anwas-scratch' ),
	...
	if ( ! empty( $author_string ) ) {
		...
		<span class="posted-by">
			...
			$author_byline = _x( 'By %s', 'post author', 'anwas-scratch' );
			if ( ! empty( $time_string ) ) {
				/* translators: %s: post author */
				$author_byline = _x( 'by %s', 'post author', 'anwas-scratch' );
			}
	...
	if ( ! empty( $parent_string ) ) {
		...
		<span class="posted-in">
			...
			$parent_note = _x( 'In %s', 'post parent', 'anwas-scratch' );
